...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding M2M table for field followed_tag on 'DukUser'
        m2m_table_name = db.shorten_name(u'account_dukuser_followed_tag')
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('dukuser', models.ForeignKey(orm[u'account.dukuser'], null=False)),
            ('tag', models.ForeignKey(orm[u'core.tag'], null=False))
        ))
        db.create_unique(m2m_table_name, ['dukuser_id', 'tag_id'])
    ...
    def backwards(self, orm):
        ...
        # Removing M2M table for field followed_tag on 'DukUser'
        db.delete_table(db.shorten_name(u'account_dukuser_followed_tag'))


    models = {
        u'account.dukuser': {
            'Meta': {'object_name': 'DukUser'},
            'followed_tag': ('django.db.models.fields.related.ManyToManyField', [], {'symmetrical': 'False', 'to': u"orm['core.Tag']", 'null': 'True', 'blank': 'True'}),
            'friends': ('django.db.models.fields.related.ManyToManyField', [], {'blank': 'True', 'related_name': "'friends_rel_+'", 'null': 'True', 'to': u"orm['account.DukUser']"}),
