...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Actor.created_on'
        db.add_column(u'core_actor', 'created_on',
                      self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, default=datetime.datetime(2013, 12, 18, 0, 0), blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Actor.created_on'
        db.delete_column(u'core_actor', 'created_on')
