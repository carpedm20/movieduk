...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'core_file', (
            ...
            ('season', self.gf('django.db.models.fields.IntegerField')(default=-1)),
            ('episode', self.gf('django.db.models.fields.IntegerField')(default=-1)),
            ('directory', self.gf('django.db.models.fields.CharField')(default='', max_length=20)),
            ('file_name', self.gf('django.db.models.fields.CharField')(default='', max_length=20)),
            ('is_drama', self.gf('django.db.models.fields.BooleanField')(default=False)),
        ))
