...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Movie.rank'
        db.add_column(u'core_movie', 'rank',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)

        # Adding field 'Movie.previous_rank'
        db.add_column(u'core_movie', 'previous_rank',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Movie.rank'
        db.delete_column(u'core_movie', 'rank')

        # Deleting field 'Movie.previous_rank'
        db.delete_column(u'core_movie', 'previous_rank')
