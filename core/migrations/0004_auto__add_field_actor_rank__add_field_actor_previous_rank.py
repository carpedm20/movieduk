...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Actor.rank'
        db.add_column(u'core_actor', 'rank',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)

        # Adding field 'Actor.previous_rank'
        db.add_column(u'core_actor', 'previous_rank',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Actor.rank'
        db.delete_column(u'core_actor', 'rank')

        # Deleting field 'Actor.previous_rank'
        db.delete_column(u'core_actor', 'previous_rank')
